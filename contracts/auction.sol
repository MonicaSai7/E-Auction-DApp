...
contract Auction {
    ...
    constructor(uint _biddingTime) public payable{ //constructor
    ...
    function withdraw() public onlybidders(msg.sender) returns (uint){
    ...
    function auctionClose() public onlyowner(msg.sender) returns (address) { //Have to be called by beneficiary after auction time is completed
